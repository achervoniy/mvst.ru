...
// Те же файлы что и в RU-версии — лежат в public/fashion-show/.
const podiumPhotos = [
    ...
    <SiteLayout transparentHeader>
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-end pb-20 px-6 text-center text-cream">
          ...
          <p className="mt-8 max-w-xl text-base md:text-lg leading-relaxed opacity-90">
            A chronicle of MVST shows — runway films, looks of the season
            and editorial frames behind the scenes.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-20 md:py-28 max-w-3xl mx-auto text-center">
        ...
        <p className="text-foreground/75 leading-relaxed text-lg">
          A runway show is a collection’s own dramaturgy. Light, music and the
          model’s movement turn quiet luxury into a gesture. Here are the films,
          the strongest frames and the chronicle of past MVST shows.
        </p>
      </section>
      ...
      <section className="py-20 md:py-28">
        <div className="px-6 md:px-12 max-w-7xl mx-auto text-center mb-12 md:mb-16">
          <h3 className="font-serif text-3xl md:text-5xl leading-tight">Looks</h3>
        </div>
