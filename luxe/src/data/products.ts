...
export const products: Product[] = [
  // WOMEN — clothing
  {
    ...
    sizes: ["XS", "S", "M", "L"],
    description:
      "Удлиненное пальто прямого силуэта из тонкого итальянского кашемира. Внутренний пояс, потайная застежка, ручная отделка лацканов.",
  ...
  },
  {
    ...
    price: 198000,
    materials: "100% итальянский лен",
    sizes: ["XS", "S", "M", "L"],
    description:
      "Платье свободного кроя из плотного льняного полотна. Драпировка по линии плеча, скрытая застежка на пуговицы.",
  ...
  },
  {
    ...
    price: 264000,
    materials: "Кашемир / шелк",
    sizes: ["XS", "S", "M", "L"],
    description:
      "Мягкий жакет из смеси кашемира и шелка. Съемный пояс, плечи без подкладки, лаконичные накладные карманы.",
  ...
  // WOMEN — accessories
  {
    ...
    sizes: ["UNI"],
    description:
      "Тонкая шаль из мягкого кашемира с ручной кистью. Теплый песочный оттенок.",
  ...
  // MEN — clothing
  {
    ...
    description:
      "Двубортный костюм с лацканами в стиле peak. Полностью на ручной сборке, шелковая подкладка.",
  ...
  },
  {
    ...
    sizes: ["S", "M", "L", "XL"],
    description:
      "Свободная рубашка из легкого льна. Воротник button-down, перламутровые пуговицы.",
  ...
  },
  {
    ...
    materials: "100% кашемир",
    sizes: ["UNI"],
    description: "Тонкий шарф из мягкого кашемира песочно-серого оттенка с легкой бахромой.",
