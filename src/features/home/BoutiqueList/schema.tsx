import barviha from './assets/must_barviha.jpg';
import dlt from './assets/must_dlt.jpg';
import raddison from './assets/must_raddison.jpg';
import td from './assets/must_td.jpg';
import tret from './assets/must_tret.jpg';
import tsum from './assets/must_tsum.jpg';
...
export const boutiqueList = [
  ...
  {
    title: 'Бутик MUST Radisson Slavyanskaya',
    image: raddison,
    address: 'Москва, площадь Европы, 2',
