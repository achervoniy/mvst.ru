...
export function mapServerMetaToClient(meta: ServerMetaType): BaseMetaType {
  return {
    ...
    ogImage: ['https://mvst.ru/static/logo.png', meta.og_image].filter(Boolean) as string[],
    ogImageAlt: meta.og_image_alt,
    // ogUrl: meta.og_image_secure_url,
    ogImageSecureUrl: meta.og_image_secure_url,
    twitterCard: meta.twitter_card,
    twitterImage: ['https://mvst.ru/static/logo.png', meta.twitter_image].filter(Boolean) as string[],
